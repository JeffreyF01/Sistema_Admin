    ...
    <div class="main-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col">
                    <h4 class="page-title">
                        <i class="fa-solid fa-magnifying-glass me-2"></i>Consulta de Roles
                    </h4>
                    <p class="page-subtitle">Visualiza los roles y su estado</p>
                </div>
                <div class="col-auto">
                    <div class="user-info">
        ...
        <div class="container-fluid">
            <div class="card card-custom fade-in mb-4">
                <div class="card-header card-header-custom d-flex align-items-center justify-content-between">
                    <h5 class="mb-0"><i class="fa-solid fa-magnifying-glass me-2"></i>Buscar Roles</h5>
                    <span class="text-muted small" id="resultCount">
                        <?php
                        if (isset($conexion) && $conexion instanceof mysqli) {
                            $countQuery = "SELECT COUNT(*) as total FROM role";
                            $countResult = $conexion->query($countQuery);
                            if ($countResult && $countResult->num_rows > 0) {
                                $countRow = $countResult->fetch_assoc();
                                echo $countRow['total'] . " roles encontrados";
                            }
                        }
                        ?>
                    </span>
                ...
                <div class="card-body">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-6">
                            <label for="searchInput" class="form-label text-required">Nombre o Descripción</label>
                            <input type="text" class="form-control form-control-custom" id="searchInput" placeholder="Ej: Administrador, Ventas...">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card card-custom fade-in">
                <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fa-solid fa-list me-2"></i>Lista de Roles</h5>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-mantenimiento" id="rolesTable">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
                            ...
                            <tbody>
                                <?php
                                if (isset($conexion) && $conexion instanceof mysqli) {
                                    $query = "SELECT id_roles, nombre, descripcion, activo FROM role ORDER BY nombre ASC";
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='4' class='text-center py-4'>
                                                ...
                                                <span class='text-muted'>No se encontraron roles registrados</span>
                                              </td></tr>";
                                    }
                                } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function aplicarFiltros() {
        ...
        rows.forEach(row => {
            ...
            let show = nombre.includes(texto) || descripcion.includes(texto);
        ...
        if (texto === '' && estado === '') {
            resultCount.textContent = rows.length + ' roles encontrados';
        } else {
            resultCount.textContent = visibles + ' roles encontrados (filtrados)';
        }
    }
