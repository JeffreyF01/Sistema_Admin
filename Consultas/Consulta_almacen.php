    ...
    <div class="main-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col">
                    <h4 class="page-title">
                        <i class="fa-solid fa-magnifying-glass me-2"></i>Consulta de Almacenes
                    </h4>
                    <p class="page-subtitle">Visualiza los almacenes registrados en el sistema</p>
                </div>
                <div class="col-auto">
                    <div class="user-info">
        ...
        <div class="container-fluid">
            <div class="card card-custom fade-in mb-4">
                <div class="card-header card-header-custom d-flex align-items-center justify-content-between">
                    <h5 class="mb-0"><i class="fa-solid fa-magnifying-glass me-2"></i>Buscar Almacenes</h5>
                    <span class="text-muted small" id="resultCount">
                        <?php
                        if (isset($conexion) && $conexion instanceof mysqli) {
                            $countQuery = "SELECT COUNT(*) as total FROM almacen";
                            $countResult = $conexion->query($countQuery);
                            if ($countResult && $countResult->num_rows > 0) {
                                $countRow = $countResult->fetch_assoc();
                                echo $countRow['total'] . " almacenes encontrados";
                            }
                        }
                        ?>
                    </span>
                ...
                <div class="card-body">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-6">
                            <label for="searchInput" class="form-label text-required">Nombre del Almacén</label>
                            <input type="text" class="form-control form-control-custom" id="searchInput" placeholder="Ej: Principal, Secundario...">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card card-custom fade-in">
                <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fa-solid fa-list me-2"></i>Lista de Almacenes</h5>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-mantenimiento" id="almacenTable">
                            <thead>
                                <tr>
                                    <th>ID</th>
                            ...
                            <tbody>
                                <?php
                                if (isset($conexion) && $conexion instanceof mysqli) {
                                    $query = "SELECT id_almacen, nombre, activo FROM almacen ORDER BY nombre ASC";
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . htmlspecialchars($row['id_almacen']) . "</td>";
                                        ...
                                        echo "<tr><td colspan='3' class='text-center py-4'>
                                                ...
                                                <span class='text-muted'>No se encontraron almacenes registrados</span>
                                              </td></tr>";
                                    }
                                } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function aplicarFiltros() {
        ...
        const rows = document.querySelectorAll('#almacenTable tbody tr');
        let visibles = 0;
        rows.forEach(row => {
        ...
        if (texto === '' && estado === '') {
            resultCount.textContent = rows.length + ' almacenes encontrados';
        } else {
            resultCount.textContent = visibles + ' almacenes encontrados (filtrados)';
        }
    }
