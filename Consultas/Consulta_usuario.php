    ...
    <div class="main-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col">
                    <h4 class="page-title">
                        <i class="fa-solid fa-magnifying-glass me-2"></i>Consulta de Usuarios
                    </h4>
                    <p class="page-subtitle">Visualiza los usuarios registrados y sus roles</p>
                </div>
                <div class="col-auto">
                    <div class="user-info">
        ...
        <div class="container-fluid">
            <div class="card card-custom fade-in mb-4">
                <div class="card-header card-header-custom d-flex align-items-center justify-content-between">
                    <h5 class="mb-0"><i class="fa-solid fa-magnifying-glass me-2"></i>Buscar Usuarios</h5>
                    <span class="text-muted small" id="resultCount">
                        ...
                        if (isset($conexion) && $conexion instanceof mysqli) {
                            ...
                            if ($countResult && $countResult->num_rows > 0) {
                                ...
                                echo $countRow['total'] . " usuarios encontrados";
                            }
                        }
                        ?>
                    </span>
                ...
                <div class="card-body">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-6">
                            <label for="searchInput" class="form-label text-required">Nombre, Usuario o Rol</label>
                            <input type="text" class="form-control form-control-custom" id="searchInput" placeholder="Ej: Juan, admin, Vendedor...">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card card-custom fade-in">
                <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fa-solid fa-list me-2"></i>Lista de Usuarios</h5>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-mantenimiento" id="usuariosTable">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
                            ...
                            <tbody>
                                <?php
                                if (isset($conexion) && $conexion instanceof mysqli) {
                                    $query = "SELECT u.id_usuarios, u.nombre, u.usuario, u.activo, r.nombre AS rol
                                              FROM usuario u
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='5' class='text-center py-4'>
                                                ...
                                                <span class='text-muted'>No se encontraron usuarios registrados</span>
                                              </td></tr>";
                                    }
                                } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function aplicarFiltros() {
        ...
        rows.forEach(row => {
            ...
            let show = nombre.includes(texto) || usuario.includes(texto) || rol.includes(texto);
        ...
        if (texto === '' && estado === '') {
            resultCount.textContent = rows.length + ' usuarios encontrados';
        } else {
            resultCount.textContent = visibles + ' usuarios encontrados (filtrados)';
        }
    }
